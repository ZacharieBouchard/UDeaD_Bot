...
public class quituestCommand2 implements Command {
	...
	public void action(String[] args, MessageReceivedEvent event) {
		...
		event.getTextChannel().sendMessage("Je suis un bot créé dans le but d'améliorer le contenu sur la communauté de la UDeaD, Merci de tavoir renseigner sur moi "+ event.getAuthor().getAsMention()).queue();
	}
